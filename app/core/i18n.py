...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "btn_prev": "⬅️ Назад",
        "btn_next": "Вперёд ➡️",
        "btn_customer_return": "🔄 Возврат от клиента",
        "customer_return_prompt": "🔄 <b>Возврат от покупателя на Главный склад</b>\n\nВведите артикул (SKU) возвращаемого товара:",
        "customer_return_qty": "✅ Найден товар: <b>{sku}</b>\n\nВведите количество для возврата (шт):",
        "customer_return_not_found": "❌ Товар с таким SKU не найден в базе или у него нет цены. Проверьте правильность SKU.",
        "customer_return_success": "✅ <b>Заявка на возврат создана!</b>\n\nТовар отправлен на Главный склад. Ожидайте подтверждения, после чего ваш долг уменьшится.",
        ...
        "sale_qty_too_large": "❌ Слишком большое количество.\nМаксимум за одну операцию: <b>{max}</b> шт.\nЕсли это ошибка — введите реальное число, не артикул.",
        ...
        "notif_approved": "✅ Ваша заявка #{id} подтверждена.\nТовар {sku} зачислен.",
        "notif_rejected": "❌ Ваша заявка #{id} отклонена.\nПричина: {reason}",
        "return_by_admin_notif": "🔄 <b>Возврат от клиента оформлен складом</b>\n\nСклад оформил возврат от вашего лица:\n{items}\n\n<i>Остатки склада и ваша касса уже обновлены.</i>",
    ...
    "tg": {
        ...
        "btn_prev": "⬅️ Қафо",
        "btn_next": "Пеш ➡️",
        "btn_customer_return": "🔄 Бозгашт аз муштарӣ",
        "customer_return_prompt": "🔄 <b>Бозгашт аз муштарӣ ба Анбори Асосӣ</b>\n\nАртикул (SKU)-и моли баргардонидашударо ворид кунед:",
        "customer_return_qty": "✅ Мол ёфт шуд: <b>{sku}</b>\n\nМиқдорро барои бозгашт ворид кунед (дона):",
        "customer_return_not_found": "❌ Мол бо ин SKU дар база ёфт нашуд ё нарх надорад. Дурустии SKU-ро санҷед.",
        "customer_return_success": "✅ <b>Дархост барои бозгашт сохта шуд!</b>\n\nМол ба Анбори Асосӣ фиристода шуд. Тасдиқро интизор шавед, пас аз он қарзи шумо кам мешавад.",
        "btn_page": "{current}/{total}",
        ...
        "sale_qty_too_large": "❌ Миқдор хеле калон аст.\nМаксимум барои як амал: <b>{max}</b> дона.\nАгар хато бошад — рақами воқеиро ворид кунед, на артикул.",
